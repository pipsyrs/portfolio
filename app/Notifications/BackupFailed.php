...
class BackupFailed extends Notification
{
    ...
    public function __construct(public string $reason, public bool $automatic = false) {}
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            'type' => 'backup',
            'title' => $this->automatic ? 'Backup otomatis gagal' : 'Backup database gagal',
            'body' => Str::limit($this->reason, 160),
