<div class="space-y-6">
    ...
    <x-dash.page-header title="Tech Stack"
                        eyebrow="Konten"
    ...
    @if ($items->isEmpty())
        <x-dash.card padding="p-0">
            <x-dash.empty-state icon="fa-solid fa-layer-group"
    ...
    <x-dash.modal :show="$showForm" close-action="closeForm" max-width="max-w-xl"
        ...
        <form wire:submit="save" class="space-y-4">
            <x-dash.input label="Nama" name="name" required wire:model="name" placeholder="Laravel" />
